...
export default function DevelopmentGalleryCard({ image, alt, href }: Props) {
  const content = (
    <div className="group relative overflow-hidden rounded-4xl border border-white/10 bg-white/3 backdrop-blur-2xl">
      ...
      <div className="relative aspect-16/11 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-linear-to-t from-[#04142F]/45 via-transparent to-transparent" />
      </div>
    </div>
  );
