...
const CONTENT = {
  ...
  highlight: "projects.",
  description:
    "A showcase of work spanning digital products, design, and creative experiments.",
  mobileMeta: ["Featured Work", "Recent Projects"],
  desktopMeta: ["Selected Projects", "Creative Work"],
} as const;
